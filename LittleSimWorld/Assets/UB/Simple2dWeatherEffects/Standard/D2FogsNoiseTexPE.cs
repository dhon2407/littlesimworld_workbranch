...
namespace UB.Simple2dWeatherEffects.Standard
{
    ...
    public class D2FogsNoiseTexPE : EffectBase
    {
        ...
        public float DensityBeforeFadingAway;
        ...
        {
            float percentage = 0;
            float startingDensity = Density;
            while (true)
            {
                percentage += 0.02f;
                Density = Mathf.SmoothStep(startingDensity, 0, percentage);
        ...
        public IEnumerator FadeIn()
        {
            ...
            {
                percentage += 0.02f;
                Density = Mathf.SmoothStep(0, DensityBeforeFadingAway, percentage);
