...
namespace UI.Cooking {
	...
	public class StoveUIManager : MonoBehaviour {
		...
		[SerializeField] GameObject CookingBase = null;
		[SerializeField] UI_ManualCookingPanel ManualCookingPanel = null;

		[Space]
		[SerializeField] Button AutoCookButton = null;
		[SerializeField] Button ManualCookButton = null;
		[SerializeField] Button CancelCookButton = null;


		public static StoveUIManager instance;
