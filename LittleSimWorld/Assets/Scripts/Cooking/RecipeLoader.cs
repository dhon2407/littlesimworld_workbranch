...
namespace Cooking.Recipe
{
    public class RecipeLoader : MonoBehaviour
    {
        ...
        private void Start()
        {
            StartCoroutine(InitializeRecipes());
        }

        private IEnumerator InitializeRecipes()
        {
            while (!handler.Initialized)
                yield return null;
        ...
        public void FetchRecipes()
        {
            ...
            foreach (var recipe in recipes)
            {
                ...
                slots[slots.Count - 1].SetItem(recipe.RecipeOutcome).CheckRequirement();
            }
